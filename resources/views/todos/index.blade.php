...
<a type="button" class="btn btn-danger mb-2"
    onclick="event.preventDefault(); document.getElementById('form-incomplete-{{$todo->id}}').submit()">Completed</a>

<form method="post" id="{{'form-incomplete-'.$todo->id}}" action="{{route('todo.incomplete',$todo->id)}}" style="display: none">
    @csrf
    @method('delete')
</form>
...
<!-- <div id="app"> -->
  <example-component :user_name="'{{auth()->user()->name}}'"></example-component>
<!-- </div> -->
